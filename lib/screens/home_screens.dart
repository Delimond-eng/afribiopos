...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _initLocalData() async {
    try {
      ...
      setState(() {
        startmsg = prefs.getString('option') == null
            ? "off"
            : prefs.getString('option');
  ...
  void getCart() async {
    try {
      ...
      List<Produits> details =
          List<Produits>.from(i.map((model) => Produits.fromJson(model)));
      Navigator.push(
          context, SlideRightRoute(page: CartPage(venteDetails: details)));
    } catch (e) {
  ...
  onSearchTextChanged(String text) async {
    _searchResult.clear();
    _searchResult = widget.catalogList
        .where((i) => i.titre.toLowerCase().contains(text))
        .toList();
    setState(() {});
  }
  ...
  Future<Null> refresh() async {
    ...
    HttpService.getCatalog().then((value) {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (context) => HomeScreen(catalogList: value.produits)),
    ...
    return Scaffold(
                  ...
                  child: _searchText.text.isNotEmpty || _searchResult.length > 0
                                    ...
                                    press: () {
                                      showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return dialog(
                                              pId: _searchResult[index]
                                                  .produitId,
                                              title: _searchResult[index].titre,
                                              image:
                                                  _searchResult[index].imageB64,
                                              prix: _searchResult[index]
                                                  .prixUnitaire,
                      ...
                      : Padding(
                          ...
                          child: catalogList.length == 0
                              ? Center(
                                  child: Text(
                                    'Vous n\'avez pas des produits !, veuillez commander sur la plateforme afribio.org !',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Colors.pink,
                                        fontSize: 16,
                                    ...
                                    return ItemCard(
                                      ...
                                      press: () {
                                        showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return dialog(
                                                pId: widget.catalogList[index]
                                                    .produitId,
                                                title: widget
                                                    .catalogList[index].titre,
                                                image: widget.catalogList[index]
                                                    .imageB64,
                                                prix: widget.catalogList[index]
                                                    .prixUnitaire,
                                                stock: widget
                                                    .catalogList[index].stock,
                                                unite: 'Kg',
                                              );
                                            });
                                      },
      ...
      floatingActionButton: MediaQuery.of(context).viewInsets.bottom == 0
          ? Padding(
              ...
              child: startmsg == 'off' || startmsg == null
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: int.parse(_controller.text) > 1
            ...
            Positioned(
              ...
              child: CircleAvatar(
                backgroundColor: Colors.transparent,
                radius: 50.0,
                child: ClipRRect(child: imageFromBase64String(image)),
              ),
            ),
          ],
        ),
  ...
  void addToCart({Produits produit}) async {
    if (startmsg == 'off' || startmsg == null) {
      EasyLoading.showInfo(
          'Vous devez commencer la journée pour effectuer une vente !',
          duration: Duration(seconds: 5));
      Navigator.pop(context);
    } else {
      if (int.parse(produit.quantite) > int.parse(produit.stock)) {
        await EasyLoading.showToast('Stock insuffisant pour cette quantité !!',
        ...
        try {
          ...
          await EasyLoading.showSuccess('produit ajouté au panier!',
              duration: Duration(seconds: 1));
          setState(() {
            _counter = prefs.getInt('count') == null
                ? detailsExist.length
                : prefs.getInt('count');
            _controller.text = '1';
          });
                    ...
                    Column(
                      ...
                      children: [
                        CircleAvatar(
                            ...
                            radius: 30,
                            child: Text(
                              jsonDecode(_authData)['nom_complet']
                                  .toString()
                                  .substring(0, 1)
                                  .toUpperCase(),
                              style: TextStyle(
              ...
              children: [
                ...
                ListTile(
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(
                        context, SlideRightRoute(page: InventoryPage()));
                  },
                ...
                ListTile(
                  onTap: () async {
                    AwesomeDialog(
                      ...
                      title: 'Deconnexion...!',
                      desc:
                          'Etes-vous sûr de vouloir vous deconnecter du POS ?',
                      buttonsTextStyle: TextStyle(color: Colors.white),
                      showCloseIcon: false,
                      btnCancelOnPress: () {},
                      btnCancelColor: Colors.grey[700],
                  ...
                  onTap: () {
                    setState(() {
                      AwesomeDialog(
                        ...
                        title: 'Avertissement !',
                        desc:
                            'Etes-vous sûr de vouloir quitter cette application ?',
                        buttonsTextStyle: TextStyle(color: Colors.white),
                        showCloseIcon: false,
                        btnCancelOnPress: () {},
                        btnCancelColor: Colors.grey[700],
